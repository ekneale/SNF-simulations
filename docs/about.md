...
[^2]: IAEA Nuclear Data Section, 'Live Chart of Nuclides', [https://www-nds.iaea.org/relnsd/vcharthtml/VChartHTML.html](https://www-nds.iaea.org/relnsd/vcharthtml/VChartHTML.html). (Accessed August 2024).

[^3]: M. R. Bhat (1992). Evaluated Nuclear Structure Data File (ENSDF). In: Qaim, S.M. (eds) Nuclear Data for Science and Technology. Research Reports in Physics. Springer, Berlin, Heidelberg. [https://doi.org/10.1007/978-3-642-58113-7_227](https://doi.org/10.1007/978-3-642-58113-7_227)
